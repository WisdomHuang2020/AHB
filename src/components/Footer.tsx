      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-text-primary">AHB Flyback Design Tool</span>
            </div>
            <p className="text-text-secondary text-sm leading-relaxed">
              不对称半桥反激变换器学习与工程设计平台，涵盖拓扑分析、ZVS 原理、公式推导与参数优化。
            </p>
          </div>
          <div>
            ...
            <div className="space-y-2">
              <Link to="/fundamentals" className="flex items-center gap-2 text-text-secondary hover:text-primary-light text-sm transition-colors">
                <BookOpen className="w-4 h-4" /> 拓扑基础
              </Link>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-muted text-sm">
            © 2026 AHB Flyback Design Tool. 仅供学习与研究使用。
          </p>
          <div className="flex items-center gap-5">
            ...
            <a
              href="https://github.com/WisdomHuang2020/AHB"
              target="_blank"
              rel="noreferrer"
